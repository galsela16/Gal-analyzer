...
if(!html.includes('GAL Analyzer V5.5.8')||!config.includes("version:'5.5.8-waterfall-frequency-precision'")||!worker.includes('v5-5-8-waterfall-frequency-precision')) throw new Error('V5.5.8 release identifiers are inconsistent');
