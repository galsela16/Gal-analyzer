...
if(!html.includes('GAL Analyzer V5.5.11')||!config.includes("version:'5.5.11-waterfall-ultra-dense'")||!worker.includes('v5-5-11-waterfall-ultra-dense')) throw new Error('V5.5.11 release identifiers are inconsistent');
