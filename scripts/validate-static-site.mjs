...
if(!html.includes('GAL Analyzer V5.5.4')||!config.includes("version:'5.5.4-waterfall-layout'")||!worker.includes('v5-5-4-waterfall-layout')) throw new Error('V5.5.4 release identifiers are inconsistent');
