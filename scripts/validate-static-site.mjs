...
if(!html.includes('GAL Analyzer V5.5.21')||!config.includes("version:'5.5.21-waterfall-10s-angle'")||!worker.includes('v5-5-21-waterfall-10s-angle')) throw new Error('V5.5.21 release identifiers are inconsistent');
