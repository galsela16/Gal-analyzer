...
if(!html.includes('GAL Analyzer V5.5.12')||!config.includes("version:'5.5.12-waterfall-smooth-motion'")||!worker.includes('v5-5-12-waterfall-smooth-motion')) throw new Error('V5.5.12 release identifiers are inconsistent');
