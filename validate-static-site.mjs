...
if(!html.includes('GAL Analyzer V5.5.13')||!config.includes("version:'5.5.13-generator-compact-dual-meter'")||!worker.includes('v5-5-13-generator-compact-dual-meter')) throw new Error('V5.5.13 release identifiers are inconsistent');
