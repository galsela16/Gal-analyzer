...
if(!html.includes('GAL Analyzer V5.5.60')||!config.includes("version:'5.5.60-integrated-workflow'")||!worker.includes('v5-5-60-integrated-workflow')) throw new Error('V5.5.60 release identifiers are inconsistent');
