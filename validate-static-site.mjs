...
if(!html.includes('GAL Analyzer V5.5.69')||!config.includes("version:'5.5.69-deep-black-workspace'")||!worker.includes('v5-5-69-deep-black-workspace')) throw new Error('V5.5.69 release identifiers are inconsistent');
