...
if(!html.includes('GAL Analyzer V5.5.65')||!config.includes("version:'5.5.65-white-outline-system'")||!worker.includes('v5-5-65-white-outline-system')) throw new Error('V5.5.65 release identifiers are inconsistent');
