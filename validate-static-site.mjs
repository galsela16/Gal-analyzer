...
if(!html.includes('GAL Analyzer V5.5.70')||!config.includes("version:'5.5.70-generator-loopback'")||!worker.includes('v5-5-70-generator-loopback')) throw new Error('V5.5.70 release identifiers are inconsistent');
