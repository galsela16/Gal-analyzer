...
if(!html.includes('GAL Analyzer V5.5.68')||!config.includes("version:'5.5.68-collision-free-alerts'")||!worker.includes('v5-5-68-collision-free-alerts')) throw new Error('V5.5.68 release identifiers are inconsistent');
