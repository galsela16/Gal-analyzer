...
if(!html.includes('GAL Analyzer V5.5.71')||!config.includes("version:'5.5.71-loopback-auto-sync'")||!worker.includes('v5-5-71-loopback-auto-sync')) throw new Error('V5.5.71 release identifiers are inconsistent');
