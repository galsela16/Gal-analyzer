...
if(!html.includes('GAL Analyzer V5.5.28')||!config.includes("version:'5.5.28-tf-global-speed-fix'")||!worker.includes('v5-5-28-tf-global-speed-fix')) throw new Error('V5.5.28 release identifiers are inconsistent');
