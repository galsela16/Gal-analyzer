...
if(!html.includes('GAL Analyzer V5.5.77')||!config.includes("version:'5.5.77-delay-field-rebuild'")||!worker.includes('v5-5-77-delay-field-rebuild')) throw new Error('V5.5.77 release identifiers are inconsistent');
