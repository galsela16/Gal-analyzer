...
if(!html.includes('GAL Analyzer V5.5.78')||!config.includes("version:'5.5.78-meter-stability'")||!worker.includes('v5-5-78-meter-stability')) throw new Error('V5.5.78 release identifiers are inconsistent');
