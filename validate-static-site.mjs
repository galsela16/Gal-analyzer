...
if(!html.includes('GAL Analyzer V5.5.73')||!config.includes("version:'5.5.73-loopback-retry'")||!worker.includes('v5-5-73-loopback-retry')) throw new Error('V5.5.73 release identifiers are inconsistent');
