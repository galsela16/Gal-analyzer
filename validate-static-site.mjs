...
if(!html.includes('GAL Analyzer V5.5.10')||!config.includes("version:'5.5.10-waterfall-frequency-cursor'")||!worker.includes('v5-5-10-waterfall-frequency-cursor')) throw new Error('V5.5.10 release identifiers are inconsistent');
