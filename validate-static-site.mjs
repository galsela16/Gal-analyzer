...
if(!html.includes('GAL Analyzer V5.5.53')||!config.includes("version:'5.5.53-wide-delay-strip'")||!worker.includes('v5-5-53-wide-delay-strip')) throw new Error('V5.5.53 release identifiers are inconsistent');
