...
if(!html.includes('GAL Analyzer V5.5.55')||!config.includes("version:'5.5.55-field-tf-workflow'")||!worker.includes('v5-5-55-field-tf-workflow')) throw new Error('V5.5.55 release identifiers are inconsistent');
