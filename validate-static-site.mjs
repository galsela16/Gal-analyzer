...
if(!html.includes('GAL Analyzer V5.5.64')||!config.includes("version:'5.5.64-unified-frequency-axis'")||!worker.includes('v5-5-64-unified-frequency-axis')) throw new Error('V5.5.64 release identifiers are inconsistent');
