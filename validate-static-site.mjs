...
if(!html.includes('GAL Analyzer V5.5.50')||!config.includes("version:'5.5.50-compact-measurement-docks'")||!worker.includes('v5-5-50-compact-measurement-docks')) throw new Error('V5.5.50 release identifiers are inconsistent');
