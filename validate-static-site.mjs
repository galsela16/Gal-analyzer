...
if(!html.includes('GAL Analyzer V5.5.57')||!config.includes("version:'5.5.57-compact-tf-panel'")||!worker.includes('v5-5-57-compact-tf-panel')) throw new Error('V5.5.57 release identifiers are inconsistent');
