...
if(!html.includes('GAL Analyzer V5.5.56')||!config.includes("version:'5.5.56-single-tf-view'")||!worker.includes('v5-5-56-single-tf-view')) throw new Error('V5.5.56 release identifiers are inconsistent');
