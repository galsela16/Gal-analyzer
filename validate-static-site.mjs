...
if(!html.includes('GAL Analyzer V5.5.54')||!config.includes("version:'5.5.54-tf-working-average'")||!worker.includes('v5-5-54-tf-working-average')) throw new Error('V5.5.54 release identifiers are inconsistent');
