...
if(!html.includes('GAL Analyzer V5.5.25')||!config.includes("version:'5.5.25-tf-visible-detailed-spectrum'")||!worker.includes('v5-5-25-tf-visible-detailed-spectrum')) throw new Error('V5.5.25 release identifiers are inconsistent');
