...
if(!html.includes('GAL Analyzer V5.5.51')||!config.includes("version:'5.5.51-compact-tf-strip'")||!worker.includes('v5-5-51-compact-tf-strip')) throw new Error('V5.5.51 release identifiers are inconsistent');
