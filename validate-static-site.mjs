...
if(!html.includes('GAL Analyzer V5.5.3')||!config.includes("version:'5.5.3-ui-refresh'")||!worker.includes('v5-5-2-ui-refresh')) throw new Error('V5.5.3 release identifiers are inconsistent');
