...
if(!html.includes('GAL Analyzer V5.5.46')||!config.includes("version:'5.5.46-vivid-waterfall'")||!worker.includes('v5-5-46-vivid-waterfall')) throw new Error('V5.5.46 release identifiers are inconsistent');
