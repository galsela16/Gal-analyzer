...
if(!html.includes('GAL Analyzer V5.5.66')||!config.includes("version:'5.5.66-canvas-status-line'")||!worker.includes('v5-5-66-canvas-status-line')) throw new Error('V5.5.66 release identifiers are inconsistent');
