...
if(!html.includes('GAL Analyzer V5.5.45')||!config.includes("version:'5.5.45-professional-finish'")||!worker.includes('v5-5-45-professional-finish')) throw new Error('V5.5.45 release identifiers are inconsistent');
