...
if(!html.includes('GAL Analyzer V5.5.44')||!config.includes("version:'5.5.44-compact-support-export'")||!worker.includes('v5-5-44-compact-support-export')) throw new Error('V5.5.44 release identifiers are inconsistent');
