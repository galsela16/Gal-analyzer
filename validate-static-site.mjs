...
if(!html.includes('GAL Analyzer V5.5.5')||!config.includes("version:'5.5.5-waterfall-perspective'")||!worker.includes('v5-5-5-waterfall-perspective')) throw new Error('V5.5.5 release identifiers are inconsistent');
