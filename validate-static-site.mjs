...
if(!html.includes('GAL Analyzer V5.5.72')||!config.includes("version:'5.5.72-continuous-tf'")||!worker.includes('v5-5-72-continuous-tf')) throw new Error('V5.5.72 release identifiers are inconsistent');
