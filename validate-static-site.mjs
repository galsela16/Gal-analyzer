...
if(!html.includes('GAL Analyzer V5.5.58')||!config.includes("version:'5.5.58-clean-tf-workflow'")||!worker.includes('v5-5-58-clean-tf-workflow')) throw new Error('V5.5.58 release identifiers are inconsistent');
