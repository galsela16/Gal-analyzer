...
if(!html.includes('GAL Analyzer V5.5.49')||!config.includes("version:'5.5.49-clean-header'")||!worker.includes('v5-5-49-clean-header')) throw new Error('V5.5.49 release identifiers are inconsistent');
