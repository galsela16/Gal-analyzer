# GAL Analyzer V5.5.53 — Wide Compact Delay Strip

V5.5.53 spreads Delay inputs and controls across the full panel width, preventing unnecessary line wrapping and reducing the compact panel to 112 px.
